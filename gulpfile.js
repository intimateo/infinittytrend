...
var project 		= 'infinity', // Project name, used for build zip.
	url 			= 'http://localhost:60/infinity/repo/Assets/', // Local Development URL for BrowserSync. Change as-needed.
 ...
 */
 ...
 gulp.task('cleanup', function() {
 	return 	gulp.src(['./assets/bower_components', '**/.sass-cache','**/.DS_Store','./dist'], { read: false }) // much faster
